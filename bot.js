...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        if (config.AFPLK == 'nezuko' || config.AFPLK == 'nezuko' || config.AFPLK == 'zimbot' || config.AFPLK == 'zimbot') {
        //thanks to afnanplk
        console.log(
            chalk.green.bold('thanks for watching -key cofirmed-')
        );
         }
         else if (config.AFPLK !== 'nezuko' || config.AFPLK !== 'nezuko' || config.AFPLK !== 'zimbot' || config.AFPLK !== 'zimbot') {
         console.log(
        ...
        console.log(
            chalk.green.bold('Nezuko 𝚠𝚘𝚛𝚔𝚒𝚗𝚐 ' + config.WORKTYPE + ' 𝚗𝚘𝚠 🍃'));
          // thanks to afnanplk
...
*/
                        ...
                        try {
                            ...
                            if (config.NOLOG === 'off') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ NEZUKO ~______~*' +

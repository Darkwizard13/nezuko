...
module.exports = {
    ...
    SESSION: process.env.NEZUKO_CODE === undefined ? '' : process.env.NEZUKO_CODE,
    ...
    PHONE: process.env.NUMBER === undefined ? '263714561176' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'GERALD' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Nezuko' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/1986d89402b68b4f4aeca.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Nezuko' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '263714561176@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ NEZUKO ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'NEZUKO' : process.env.BOT_NAME,
